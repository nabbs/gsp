                                ...
                                <div class="col-sm-12">
                                    <table id="example2" class="table table-bordered table-hover dataTable" role="grid"
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                                colspan="1">
                                                <?php echo $this->Paginator->sort('type', 'Displayed in'); ?>
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                                colspan="1"
                                                aria-label="Engine version: activate to sort column ascending">
                                                <a href="/panel/add_article" class="btn btn-primary">
                                        ...
                                        <? foreach ($articles as $article) { ?>
                                            <tr role="row" class="odd">
                                                <td class="sorting_1"><? echo $article['Article']['title']; ?></td>
                                                <td><? echo ($article['Article']['active'] == 1) ? "Enabled" : "Disabled"; ?></td>
                                                <td><? echo $article['Article']['type']; ?></td>
                                                <td>
                                                    <a href="/panel/edit_article/<? echo $article['Article']['id']; ?>"
                                                       class="btn btn-primary">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <?php echo $this->Form->postLink('<i class="fa fa-trash"></i>',
                                                        array('action' => 'delete_article', $article['Article']['id']),
                                                        array('confirm' => 'Delete article "' . $article['Article']['title'] . '"?', 'escape' => false, 'class' => 'btn btn-danger')
                                                    ); ?>
                                                </td>
                                            </tr>
                                        <? } ?>
                                        ...
                                        <tr>
                                            ...
                                            <th rowspan="1" colspan="1">Displayed in</th>
